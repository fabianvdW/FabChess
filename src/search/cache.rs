...
pub struct CacheEntry {
    ...
    //1-Bit
    pub mv: u16,//16-Bit
    //Insg 179-Bit 23-Bytes
}

impl CacheEntry {
    pub fn new(game_state: &GameState, depth_left: usize, score: f64, pv: bool, alpha: bool, beta: bool, mv: &GameMove) -> CacheEntry {
        CacheEntry {
            hash: game_state.hash,
            depth: depth_left as u8,
            occurences: 0,
            plies_played: game_state.half_moves as u16,
            score,
            pv,
            alpha,
            beta,
