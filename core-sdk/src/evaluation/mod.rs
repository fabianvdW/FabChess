...
pub fn sum_attacks(g: &GameState, side: usize) -> (u64, u64) {
    ...
    let mut defended_by_minors =
        pawn_targets(side, g.pieces[PAWN][side]) | knight_attacks(g.pieces[KNIGHT][side]);
    let mut enemy_bishops = g.pieces[BISHOP][side];
